...
public class EmployeePanel extends JPanel {
    ...
    private void searchEmployee() {
        ...
        String sql = "SELECT id, name, gender, age, marry, contact, education, title, salary, department_id, retire_status, resume, employee_id, salary_date FROM employee WHERE name LIKE ? OR contact LIKE ? OR education LIKE ?";
